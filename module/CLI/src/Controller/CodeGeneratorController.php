...
use BS\CLI\Exception;
use BS\CLI\Model\AbstractCodeGenerator;
use BS\CLI\Model\CodeGenerator\AbstractFileGenerator;
use BS\CLI\Model\CodeGeneratorConfiguration;
use BS\CLI\Model\SourceCodeGenerator;
use BS\CLI\Model\TestCodeGenerator;
...
class CodeGeneratorController extends AbstractConsoleActionController
{
    ...
    protected function getTables($tableNames = [])
    {
        ...
        if (!$this->tables) {
            ...
            $metadata = Factory::createSourceFromAdapter($dbAdapter);
