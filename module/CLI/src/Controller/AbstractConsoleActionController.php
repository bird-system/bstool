...
namespace BS\CLI\Controller;

use BS\CLI\ServiceLocatorAwareInterface;
use BS\CLI\Traits\ServiceLocatorAwareTrait;
use Zend\Console\ColorInterface;
use Zend\Console\Console;
use Zend\Console\Request as ConsoleRequest;
use Zend\Mvc\Console\Controller\AbstractConsoleController as Base;

/**
 * Class AbstractConsoleActionController
 *
 * @package BS\CLI\Controller
 * @method ConsoleRequest getRequest()
 */
abstract class AbstractConsoleActionController extends Base implements ServiceLocatorAwareInterface
{
